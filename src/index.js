 ...
 * @return {string}
 */
fromXPrv.prototype.getPrivateKey = function (index, index1) {
    prvkey = bip32.fromBase58(this.xprv, this.network).derive(index1).derive(index)
 ...
 * @return {string}
 */
fromXPrv.prototype.getPublicKey = function (index, index1) {
   pubKey = bip32.fromBase58(this.xprv, this.network).derive(index1).derive(index).publicKey
 ...
 * @return {string}
 */
fromXPrv.prototype.getAddress = function (index, index1, purpose) {
   pubkey = bip32.fromBase58(this.xprv, this.network).derive(index1).derive(index).publicKey
